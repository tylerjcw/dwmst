#define STATUS_BAR      "dzen2 -p -xs 1 -x 590 -y 754 -fg '#dcdcdc' -bg '#303030' -h 14 -w 434 -ta r -fn '-*-bitocra-*-*-*-*-*-*-*-*-*-*-*-*'"
...
#define BAT_25      "^fg(#D370A3)^fn(stlarch)^fn()^fg()%03i%%"
#define BAT_50      "^fg(#EFBD8B)^fn(stlarch)^fn()^fg()%03i%%"
#define BAT_75      "^fg(#6D9E3F)^fn(stlarch)^fn()^fg()%03i%%"
#define BAT_100     "^fg(#6095C5)^fn(stlarch)^fn()^fg()%03i%%"

#define CRG_25      "^fg(#D370A3)^fn(stlarch)^fn()^fg()%03i%%"
#define CRG_50      "^fg(#EFBD8B)^fn(stlarch)^fn()^fg()%03i%%"
#define CRG_75      "^fg(#6D9E3F)^fn(stlarch)^fn()^fg()%03i%%"
#define CRG_100     "^fg(#6095C5)^fn(stlarch)^fn()^fg()%03i%%"

#define AC_PWR      "^fg(#EFBD8B)^fn(stlarch)^fn()^fg() AC "

#define UPDATE_FILE "/home/komrade/log/updates.log"

#define OUT_TO_CONSOLE false